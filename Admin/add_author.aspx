<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/M1.master" AutoEventWireup="true" CodeFile="add_author.aspx.cs" Inherits="Admin_Default2" %>
                    ...
                    <form id="Form1" class="form-horizontal form-label-left" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <asp:TextBox ID="txtauthorname" class="form-control col-md-7 col-xs-12" runat="server" placeholder="Enter Author" required=""></asp:TextBox>
                        </div>
                      </div>
                      <div class="form-group">
